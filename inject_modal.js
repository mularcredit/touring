    ...
    <div class="kz-modal-inner">
        ...
        <div class="kz-modal-text-col">
            ...
            <div class="kz-modal-elegant-note" id="modalNote">
                An unforgettable African experience, meticulously curated for the discerning traveler to capture the magic of the wild.
            </div>

            <div class="kz-modal-price-box">
                <span class="price-label">Kaleola Zar Exclusive</span>
                <span class="price-val">Inquire via Book Now</span>
            </div>

            <a href="#contact" class="kz-modal-book-btn" id="modalBookBtn" onclick="closeDiscoverModal()">Book Your Journey</a>
            <div style="margin-top:20px; font-size: 10px; color: #7b9986;">* All packages include premium accommodation and guided tours. Terms and conditions apply.</div>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        gridItems.forEach((item, index) => {
            item.addEventListener('click', function(e) {
                ...
                mBadge.innerText = String(index + 420).padStart(3, '0'); // Fun detail mapping to the "421" "422" numbers on the menu image
...
if (!html.includes('id="discoverModal"')) {
    ...
    // Overwrite the existing logic if it exists (for easy updates)
